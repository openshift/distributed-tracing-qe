...
kubectl -n rapidast-jaeger wait --for=condition=Ready pod/$RANDOM_NAME
kubectl -n rapidast-jaeger cp $RANDOM_NAME:/zap/results $ARTIFACT_DIR
kubectl -n rapidast-jaeger delete pod $RANDOM_NAME
